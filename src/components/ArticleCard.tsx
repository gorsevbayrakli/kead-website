...
export function ArticleCard({ article }: { article: Article }) {
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-3xl bg-white transition-transform duration-150 hover:-translate-y-0.5"
      style={{ boxShadow: "var(--shadow-soft)" }}
    >
      <ArticleIllustration article={article} className="h-44" />
